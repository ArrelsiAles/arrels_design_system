...
class ArrelsBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (background, foreground) = switch (tone) {
      ArrelsBadgeTone.neutral => (
        colors.surfaceSubtle,
        colors.contentSecondary,
      ),
      ArrelsBadgeTone.info => (colors.infoBackground, colors.infoForeground),
      ArrelsBadgeTone.success => (
        colors.successBackground,
        colors.successForeground,
      ),
      ArrelsBadgeTone.warning => (
        colors.warningBackground,
        colors.warningForeground,
      ),
      ArrelsBadgeTone.danger => (
        colors.dangerBackground,
        colors.dangerForeground,
      ),
      ArrelsBadgeTone.brand => (
        colors.brandAccentSoft,
        colors.brandOnAccentLarge,
      ),
    };
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            label,
            style: ArrelsTextStyles.caption.copyWith(color: foreground),
          ),
        ],
      ),
    );
