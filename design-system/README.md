...
Este directorio es la fuente de verdad neutral respecto a la tecnología. Define decisiones de diseño, tokens, contratos de componentes y patrones de producto para que una pantalla conserve la misma identidad al implementarse en web, Flutter u otra plataforma.
...
2. [`tokens/`](tokens/): valores machine-readable siguiendo la estructura de Design Tokens Community Group.
...
- Componentes: especificación documental, no paquete ejecutable.
- Adaptadores: fuera de esta versión.
