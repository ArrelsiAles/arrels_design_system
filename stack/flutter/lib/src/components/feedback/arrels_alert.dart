...
class ArrelsAlert extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (background, foreground) = switch (tone) {
      ...
      ArrelsTone.success => (colors.successBackground, colors.successForeground),
      ArrelsTone.warning => (colors.warningBackground, colors.warningForeground),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(
          variant == ArrelsAlertVariant.page ? ArrelsRadius.lg : ArrelsRadius.md,
        ),
      ),
      child: Row(
