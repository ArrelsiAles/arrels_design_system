        ...
        children: [
          Row(
            children: [
              ...
              Text(
                'Sense connexió',
                style: ArrelsTextStyles.label.copyWith(color: colors.warningForeground),
              ),
            ],
          ),
          if (lastSync != null)
            Padding(
              ...
              child: Text(
                ...
                style: ArrelsTextStyles.bodySmall.copyWith(color: colors.contentPrimary),
              ),
            ),
          ...
          if (available.isNotEmpty)
            Padding(
              ...
              child: Text(
                ...
                style: ArrelsTextStyles.caption.copyWith(color: colors.contentSecondary),
              ),
            ),
          if (onRetry != null)
            Padding(
